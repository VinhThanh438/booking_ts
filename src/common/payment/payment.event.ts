...
import { DEDUCT_USER_MONEY, REFUND_TO_USER, UPDATE_TICKET_QUANTITY } from '@common/constant/jobname.constant';
...
export class PaymentEvent {
    ...
    public static async createdHandler(data: any, done: DoneCallback): Promise<void> {
        try {
    ...
    public static async canceledHandler(data: any, done: DoneCallback): Promise<void> {
        try {
